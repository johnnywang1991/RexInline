# This Makefile is for the Rex::Inline extension to perl.
#
...
#     AUTHOR => [q[johnnywang <johnnywang1991@msn.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
...
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Rex/Inline.pm]
#     clean => { FILES=>q[Rex-Inline-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Rex/Inline.pm \
	lib/Rex/Inline/Base.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Rex
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Rex
...
TO_INST_PM = lib/Rex/Inline.pm \
	lib/Rex/Inline/Base.pm \
	lib/Rex/Inline/Test.pm \
	t.pl

PM_TO_BLIB = lib/Rex/Inline.pm \
	blib/lib/Rex/Inline.pm \
	lib/Rex/Inline/Base.pm \
	blib/lib/Rex/Inline/Base.pm \
	lib/Rex/Inline/Test.pm \
	blib/lib/Rex/Inline/Test.pm \
	t.pl \
	$(INST_LIB)/Rex/t.pl
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Rex/Inline.pm $(INST_MAN3DIR)/Rex::Inline.$(MAN3EXT) \
	  lib/Rex/Inline/Base.pm $(INST_MAN3DIR)/Rex::Inline::Base.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''johnnywang <johnnywang1991@msn.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Rex-Inline' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  File::Path::Tiny: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'version: v0.0.5' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "unknown",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "johnnywang <johnnywang1991@msn.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Rex-Inline",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "File::Path::Tiny" : "0",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Rex" : "0",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   "version" : "v0.0.5"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>johnnywang &lt;johnnywang1991@msn.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="File::Path::Tiny" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="MooseX::AttributeShortcuts" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Parallel::ForkManager" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Rex::" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Rex/Inline.pm blib/lib/Rex/Inline.pm \
	  lib/Rex/Inline/Base.pm blib/lib/Rex/Inline/Base.pm \
	  lib/Rex/Inline/Test.pm blib/lib/Rex/Inline/Test.pm \
	  t.pl $(INST_LIB)/Rex/t.pl 
